...
def main(page: ft.Page):
    ...
    try:
        ...
        page.clean()
        page.add(
            ft.Text("¡CRASH AL INICIAR!", size=25, weight="bold", color=ft.Colors.RED),
            ft.Text("Tómale captura a esto:", color=ft.Colors.AMBER),
            ft.Text(error_texto, selectable=True, size=11)
        )
        page.update()
